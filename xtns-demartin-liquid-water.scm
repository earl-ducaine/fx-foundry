...
(let* ((Highlight_up   (car (gimp-layer-copy Bump-Layer FALSE)))
    ...
    (gimp-drawable-set-name Shadow "Shadow")
    (gimp-drawable-set-name Highlight_up "Highlight_up")
    (gimp-drawable-set-name Highlight_down "Highlight_down")
    (gimp-drawable-set-name Highlight_fill "Highlight_fill")
    (gimp-drawable-set-name Bump-Layer "Bump-Layer")
