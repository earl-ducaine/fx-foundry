...
; Cyano
;
            ((= InType 0) (gimp-context-set-foreground '(68 174 246)))
;
; Palladium (Yellow)
;
            ((= InType 1) (gimp-context-set-foreground '(143 153 69)))
;
; Selenium (Magenta)
;
            ((= InType 2) (gimp-context-set-foreground '(158 79 104)))
;
; Sepia (Brown)
;
            ((= InType 3) (gimp-context-set-foreground '(167 127 92)))
;
; Sepia (Grey)
;
            ((= InType 4) (gimp-context-set-foreground '(162 138 101)))
;
; Sepia (Red)
;
            ((= InType 5) (gimp-context-set-foreground '(184 110 55)))
;
; Sepia (Yellow)
;
            ((= InType 6) (gimp-context-set-foreground '(181 127 52)))
;
; Silver (Blue)
;
            ((= InType 7) (gimp-context-set-foreground '(92 153 154)))
;
; Selection
;
