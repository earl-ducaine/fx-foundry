...
; White
;
            ((= InColorPre 0) (gimp-context-set-foreground '(240 240 240)))
;
; Gray
;
            ((= InColorPre 1) (gimp-context-set-foreground '(127 127 127)))
;
; Black
;
            ((= InColorPre 2) (gimp-context-set-foreground '(15 15 15)))
;
; Selection
;
